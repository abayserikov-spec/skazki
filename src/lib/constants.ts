...
export const I18N = {
  ru: {
    ...
    skazka: "Сказка",
    vmeste: "Вместе",
    aiCreates: "ИИ создаёт уникальную сказку.",
    readTogether: "Вы читаете вместе с ребёнком.",
    yourName: "Ваше имя",
    email: "Email",
    login: "Войти",
    back: "Назад",
    ...
    min: "мин",
    pages: "стр.",
    storyFor: "История для",
    whatAbout: "О чём будет история? Выберите идею или придумайте свою",
    storyIdeas: "Идеи для истории",
    more: "Ещё",
    generating: "Генерируем идеи…",
    noIdeas: "Не удалось загрузить. Нажмите «Ещё»",
    needKey: "Нужен API ключ для генерации идей",
    writeYourOwn: "Или напишите свою",
    premisePlaceholder:
      "Например: Мальчик хочет выиграть школьный чемпионат по шахматам...",
    anyGenre: "Реалистичная, фэнтези, фантастика — что угодно.",
    startStory: "Начать историю",
    clear: "Очистить",
    artStyle: "Стиль иллюстраций",
    styleBook: "Книжная иллюстрация",
    styleBookDesc: "Тёплая акварель, как в детских книгах",
    styleAnime: "Аниме",
    styleAnimeDesc: "Яркий стиль как Ghibli / Shinkai",
    styleRealistic: "Реалистичный",
    styleRealisticDesc: "Фотореалистичный стиль",
    settings: "Настройки",
    done: "Готово",
    logout: "Выйти",
    creatingStory: "Создаём сказку",
    continuing: "Продолжение…",
    end: "Конец",
    viewReport: "Смотреть отчёт",
    orCustom: "или придумайте свой вариант:",
    heroAction: "Что хочет сделать герой?..",
    speak: "Озвучить",
    stop: "Стоп",
    auto: "авто",
    sounds: "звуки",
    quiet: "тихо",
    sessionReport: "Отчёт сессии",
    journey: "Путешествие",
    choices: "выборов",
    choicesOf: "Выборы",
    fullStory: "Сказка целиком",
    decisionPath: "Путь выборов",
    newSessionBtn: "Новая сессия",
    dashboardBtn: "Дашборд",
    disclaimer:
      "Все истории создаются ИИ с фильтрацией контента по возрасту. Контент безопасен для детей, но рекомендуется присутствие родителя.",
    finish: "Завершить",
    page: "стр.",
    of: "из",
    parentPremise: "Предыстория от родителя",
    discussionQ: "Вопрос для обсуждения",
    ending: {
      good: "Счастливый конец",
      mixed: "Неоднозначный финал",
      sad: "Грустный конец",
    },
    whatNext: "Что дальше?",
  ...
  en: {
    ...
    skazka: "Story",
    vmeste: "Together",
    aiCreates: "AI creates a unique story.",
    readTogether: "Read it together with your child.",
    yourName: "Your name",
    email: "Email",
    login: "Enter",
    back: "Back",
    ...
    pages: "p.",
    storyFor: "Story for",
    whatAbout: "What will the story be about? Choose an idea or write your own",
    storyIdeas: "Story Ideas",
    more: "More",
    generating: "Generating ideas…",
    noIdeas: "Failed to load. Press «More»",
    needKey: "API key needed for ideas",
    writeYourOwn: "Or write your own",
    premisePlaceholder:
      "E.g.: A boy wants to win the school chess tournament...",
    anyGenre: "Realistic, fantasy, sci-fi — anything goes.",
    startStory: "Start Story",
    clear: "Clear",
    artStyle: "Illustration Style",
    styleBook: "Book Illustration",
    styleBookDesc: "Warm watercolor, like children's books",
    styleAnime: "Anime",
    styleAnimeDesc: "Bright Ghibli / Shinkai style",
    styleRealistic: "Realistic",
    styleRealisticDesc: "Photorealistic style",
    settings: "Settings",
    done: "Done",
    logout: "Log out",
    ...
    orCustom: "or write your own action:",
    heroAction: "What does the hero want to do?..",
    speak: "Listen",
    stop: "Stop",
    auto: "auto",
    sounds: "sounds",
    ...
    journey: "Journey of",
    choices: "choices",
    choicesOf: "Choices by",
    fullStory: "Full Story",
    decisionPath: "Decision Path",
    newSessionBtn: "New Session",
    dashboardBtn: "Dashboard",
    disclaimer:
      "All stories are AI-generated with age-appropriate content filtering. Content is safe for children, but parental supervision is recommended.",
    finish: "Finish",
    page: "p.",
    of: "of",
    parentPremise: "Parent's premise",
    discussionQ: "Discussion question",
