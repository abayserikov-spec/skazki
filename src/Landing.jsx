...
const STORY_STEPS = [
  {
    ...
    copy:
      "Choose from a few starters or invent your own — a brave fox, a shy dragon, your child's favourite stuffed bear. Whoever they fancy tonight.",
    ideas: [
  ...
  },
  {
    ...
    copyOffset: "100px",
    copy:
      "They tell you, you type. The story unfolds with pictures and plot twists \u2014 surprising even you. No script, no right answer, no homework.",
    ideas: [
  ...
  },
  {
    ...
    titleXOffset: "-16px",
    copy:
      "Every story lives in your library. Loved last night's adventure? Open it again \u2014 or pick up where you left off and write the next chapter.",
    ideas: [
  ...
  },
  {
    ...
    displayTitle: ["ow you are ready to start", "your first interactive", "journey"],
    copy: "",
    copyOffset: "246px",
    titleMaxWidth: "390px",
    ideas: [
...
const WHY_PARENTS_SLIDES = [
  {
    ...
    copy:
      "Not another video to zone out to. You're sitting next to each other, laughing at what the dragon did next, deciding together what happens on the next page.",
  ...
  },
  {
    ...
    copy:
      "Long car ride? Waiting at the doctor's? Quiet half-hour before tea? Open Anyturn, pick up where you left off, and reading ritual goes wherever you go.",
  ...
  },
  {
    ...
    copy:
      "Granny down the road or on the other side of the world — share your screen on a video call and create the next chapter together. Distance stops being the thing that ends storytime.",
  ...
  },
  {
    ...
    copy:
      "Decisions shape the story. Every choice has consequences — in a world that’s safe, but full of possibilities. Kindness, risk, and curiosity all lead to different paths.",
...
const MOMENT_SLIDES = [
  ...
  },
  {
    ...
    copy:
      "An afternoon on the sofa, building a world together. No need to find the right book - make the one your child wants right now.",
  ...
  },
  {
    ...
    color: "#438F5D",
    activeText: "#FFFFFF",
    displayTitle: ["urn waiting time and long", "drives into something", "meaningful"],
...
const REAL_FAMILY_STORIES = [
  ...
  },
  {
    ...
    quote: "\"The dragon looked everywhere. Under the clouds, behind the moon, even inside a volcano...\"",
  },
  {
    title: "The Graphic Ghost",
    chapters: "2 chapters",
    ...
    age: "6 years old",
    cover: "real-family-book.png",
    quote: "\"A tiny blue door opened in the skirting board and whispered her name...\"",
  },
  {
    title: "The Graphic Ghost",
    chapters: "6 chapters",
    ...
    age: "8 years old",
    cover: "real-family-book.png",
    quote: "\"Every stair creaked in a different voice, and one of them sounded friendly...\"",
  },
  {
    title: "The Graphic Ghost",
    chapters: "4 chapters",
    ...
    age: "5 years old",
    cover: "real-family-book.png",
    quote: "\"The blanket fort became a castle the moment the lights went out...\"",
  },
  {
    title: "The Graphic Ghost",
    chapters: "5 chapters",
    ...
    age: "7 years old",
    cover: "real-family-book.png",
    quote: "\"He packed one biscuit, two wishes, and a compass that pointed to cake...\"",
  },
];

const FAMILY_QUOTES = [
  {
    quote: "\"My daughter asks for 'our story' every single night now. It's become our favourite bedtime ritual.\"",
    author: "Emma, Mum, Bristol",
    avatar: "family-say-emma.png",
  },
  {
    quote: "\"Finally screen time I don't feel guilty about. We make it together — he’s thinking, deciding, creating.\"",
  ...
  {
    quote: "\"It turns bedtime from a negotiation into something we both look forward to.\"",
    author: "Sarah, Mum of Two, London",
    avatar: "social-proof-avatar.png",
  },
  {
    quote: "\"The best part is hearing what he chooses. The story feels like it belongs to him.\"",
...
const PRICING_PLANS = [
  {
    ...
    features: ["2 stories / week", "Basic illustrations", "Save up to 5 stories"],
  ...
  },
  {
    ...
    features: ["15 stories / month", "HD illustrations", "Unlimited library", "Share stories"],
  ...
  },
  {
    ...
    features: ["Unlimited stories", "HD illustrations", "Print physical books", "Priority support"],
    bg: "pricing-watercolor-green.png",
...
function Button({ children, variant = "primary", className = "" }) {
  return (
    <button className={`landing-button ${variant} ${className}`} onClick={goToProduct} type="button">
      {children}
    </button>
  );
}
  ...
  return (
    <header className="landing-header">
      <div className="landing-header__inner">
        <img className="landing-logo" src={`${MEDIA}logo-dark.png`} alt="anyturn" />

        <nav className="landing-header__actions" aria-label="Landing navigation">
          <Button variant="outline">Sign In</Button>
          <Button variant="navy">Start Free</Button>
        </nav>
      </div>
    </header>
  );
...
function Hero() {
  return (
    <section className="hero" aria-label="A book you make together with your child">
      <video
      ...
      <div className="hero__content">
        <img className="hero__mini-logo" src={`${MEDIA}hero-logo.png`} alt="anyturn" />
        ...
        <p className="hero__copy">
          ...
          <span>The pages come to life in front of you — words, pictures, plot twists and all.</span>
        </p>
  ...
  return (
    <section className="social-proof" aria-label="Parent testimonial">
      <div className="social-proof__inner">
        <img className="social-proof__quote-mark" src={`${MEDIA}quote-mark.png`} alt="" aria-hidden="true" />

        <blockquote className="social-proof__quote">
          My daughter asks for 'our story' every single night now. It's become our favorite bedtime ritual.
        </blockquote>

        <div className="social-proof__author" aria-label="Sarah, mum of two, London">
          <img className="social-proof__avatar" src={`${MEDIA}social-proof-avatar.png`} alt="" aria-hidden="true" />
...
function StoryStepVisual({ step }) {
  if (step.visual === "bookSpread") {
    return (
      <div className="story-steps__panel story-steps__panel--spread" aria-label="Generated storybook preview">
        <img
  ...
  if (step.visual === "choice") {
    return (
      <div className="story-steps__panel story-steps__panel--book" aria-label="Story continuation preview">
        <div className="story-steps__book-preview">
          <div className="story-steps__book-page">
            <span aria-hidden="true">Chapter 1</span>
            <p>The fox found a bright blue door under the roots of the oldest tree.</p>
          </div>
        ...
        <div className="story-steps__choice-list">
          {step.ideas.map((idea) => (
            <button className="story-steps__choice" key={idea} onClick={goToProduct} type="button">
              {idea}
            </button>
          ))}
        </div>
  ...
  if (step.visual === "library") {
    return (
      <div className="story-steps__panel story-steps__panel--library" aria-label="Generated story covers">
        <div className="story-steps__covers">
          {Array.from({ length: 6 }, (_, index) => (
            <button
              ...
              type="button"
            >
              <img src={`${MEDIA}story-step-cover.png`} alt="" aria-hidden="true" />
            </button>
          ))}
        </div>
      </div>
  ...
  if (step.visual === "finalCta") {
    return (
      <div className="story-steps__panel story-steps__panel--final" aria-label="Start your first story">
        <button className="story-steps__final-button" onClick={goToProduct} type="button">
          {step.custom}
        </button>
      </div>
    );
  ...
  return (
    <div className="story-steps__panel story-steps__panel--ideas" aria-label="Story idea examples">
      <h3>Ideas for your story</h3>

      <div className="story-steps__ideas">
        {step.ideas.map((idea, index) => (
          <button className="story-steps__idea" key={`${idea}-${index}`} onClick={goToProduct} type="button">
      ...
      <div className="story-steps__custom">
        ...
        <button className="story-steps__prompt" onClick={goToProduct} type="button">
...
function StorySteps() {
  ...
  const [activeStepIndex, setActiveStepIndex] = useState(() => {
    ...
    return Number.isInteger(parsed) && parsed >= 0 && parsed < STORY_STEPS.length ? parsed : 0;
  });

  useEffect(() => {
    activeStepIndexRef.current = activeStepIndex;
    window.sessionStorage.setItem(STORY_STEPS_STORAGE_KEY, String(activeStepIndex));
  }, [activeStepIndex]);
  ...
  const snapSectionToTop = (behavior = "auto") => {
  ...
  const scrollToAdjacentSection = (direction, event) => {
    const section = sectionRef.current;
  ...
  const handleStepIntent = (direction, event) => {
    const section = sectionRef.current;
    const control = trackRef.current;
    ...
    const isInControlZone = controlRect.top <= viewportCenter && controlRect.bottom >= viewportCenter;
    const isVisible = sectionRect.top < viewportHeight && sectionRect.bottom > 0;
    const isEnteringFromAbove =
      direction > 0 && controlRect.top > viewportHeight * 0.18 && controlRect.top <= viewportHeight * 0.92;
    const isEnteringFromBelow =
      direction < 0 && controlRect.bottom < viewportHeight * 0.82 && controlRect.bottom >= viewportHeight * 0.08;
  ...
  useEffect(() => {
    const handleWheel = (event) => {
      if (Math.abs(event.deltaY) < 10 || Math.abs(event.deltaX) > Math.abs(event.deltaY)) {
        return;
      }
  ...
  const handleStepDelta = (direction) => {
    const currentIndex = activeStepIndexRef.current;
    const nextIndex = Math.min(STORY_STEPS.length - 1, Math.max(0, currentIndex + direction));
      ...
      <div className="story-steps__pin">
        ...
        >
          <div
            ...
            style={{ transform: `translate3d(-${activeStepIndex * 100}%, 0, 0)` }}
          >
                    ...
                    <div className="story-steps__title-wrap">
                      <h3>
                        {Array.isArray(step.displayTitle)
                          ? step.displayTitle.map((line) => <span key={line}>{line}</span>)
        ...
        <div className="story-steps__pagination" aria-label="Story step pagination">
          {STORY_STEPS.map((step, index) => {
            ...
            return (
              <button
                ...
                data-state={isActiveStep ? "active" : isPastStep ? "past" : "future"}
                disabled={!isPastStep}
                key={step.title}
...
const STORY_CHOICE_STATES = {
  ...
  help: {
    prompt: "Now you are ready to return to the Village with a Golden key and continue your adventure...",
    stageImage: "story-choice-stage-help.png",
  },
  leave: {
    prompt: "The offended Woolfie you left in the net is now protecting the Golden Key and won't let you get any closer.",
    stageImage: "story-choice-stage-leave.png",
  },
};

function StoryChoicePreview() {
  const [choiceState, setChoiceState] = useState("start");
  const [stageTransition, setStageTransition] = useState(null);
  const turnTimersRef = useRef([]);
    ...
    >
      <div className="story-choice__inner">
        <div className="story-choice__heading">
          ...
          <p>Every decision has a consequence. Just like real life, but in a safe, magical world</p>
        </div>
...
function WhyParentsLoveIt() {
  ...
  const [activeSlideIndex, setActiveSlideIndex] = useState(() => {
    ...
    return Number.isInteger(parsed) && parsed >= 0 && parsed < WHY_PARENTS_SLIDES.length ? parsed : 0;
  });

  useEffect(() => {
    activeSlideIndexRef.current = activeSlideIndex;
    window.sessionStorage.setItem(WHY_PARENTS_STORAGE_KEY, String(activeSlideIndex));
  }, [activeSlideIndex]);
  ...
  const snapWhySectionToTop = (behavior = "auto") => {
    const section = sectionRef.current;
  ...
  const scrollToAdjacentWhySection = (direction, event) => {
    const section = sectionRef.current;
    const target = direction > 0 ? section?.nextElementSibling : section?.previousElementSibling;
  ...
  const handleWhyStepIntent = (direction, event) => {
    const section = sectionRef.current;
    const carousel = carouselRef.current;
  ...
  const handleManualWhyStep = (index) => {
  ...
  const handleWhyKeyDown = (event) => {
    ...
    const currentIndex = activeSlideIndexRef.current;
    const nextIndex = Math.min(WHY_PARENTS_SLIDES.length - 1, Math.max(0, currentIndex + direction));
  ...
  return (
    <section className="why-parents" aria-labelledby="why-parents-title" ref={sectionRef}>
      ...
      >
        ...
        <div className="why-parents__pagination" aria-label="Why parents love it pagination">
          {WHY_PARENTS_SLIDES.map((page, pageIndex) => {
            ...
            return (
              <button
                ...
                data-state={isActiveSlide ? "active" : isPastSlide ? "past" : "future"}
                disabled={!isPastSlide}
                key={page.displayTitle.join(" ")}
                onClick={() => handleManualWhyStep(pageIndex)}
                style={{ "--why-page-color": page.color }}
                type="button"
              />
            );
          })}
...
function StoriesFromRealFamilies() {
  const [activeStoryIndex, setActiveStoryIndex] = useState(() => {
    try {
      const saved = window.sessionStorage.getItem(REAL_FAMILY_STORY_STORAGE_KEY);
      const parsed = saved ? JSON.parse(saved) : null;

      return Number.isInteger(parsed?.index) && parsed.index >= 0 && parsed.index < REAL_FAMILY_STORIES.length
        ? parsed.index
        : 2;
    } catch {
      return 2;
  ...
  const selectStory = (index) => {
    ...
    window.sessionStorage.setItem(REAL_FAMILY_STORY_STORAGE_KEY, JSON.stringify({ index }));
  };
    ...
    <section className="real-stories" aria-labelledby="real-stories-title">
      ...
      <div className="real-stories__showcase">
        <div className="real-stories__feature">
          <button className="real-stories__cover-button" onClick={goToProduct} type="button">
            <img src={`${MEDIA}${activeStory.cover}`} alt={`${activeStory.title} book cover`} />
          </button>
          ...
          <div className="real-stories__details">
            ...
            <div className="real-stories__meta" aria-label={`Created by ${activeStory.author}, ${activeStory.age}`}>
        ...
        <div className="real-stories__rail" aria-label="Choose a real family story">
...
function FamilyVideoBlock() {
  return (
    <section className="family-video" aria-label="Anyturn family video">
      <button className="family-video__button" type="button" aria-label="Play Anyturn family video">
...
function ForEveryMoment() {
  ...
  const [activeSlideIndex, setActiveSlideIndex] = useState(() => {
    ...
    return Number.isInteger(parsed) && parsed >= 0 && parsed < MOMENT_SLIDES.length ? parsed : 0;
  });

  useEffect(() => {
    activeSlideIndexRef.current = activeSlideIndex;
    window.sessionStorage.setItem(MOMENTS_STORAGE_KEY, String(activeSlideIndex));
  }, [activeSlideIndex]);
  ...
  const setActiveMomentSlide = (index) => {
    activeSlideIndexRef.current = index;
    setActiveSlideIndex(index);
  };
  ...
  const snapMomentSectionToTop = (behavior = "auto") => {
    const section = sectionRef.current;
    const carousel = carouselRef.current;
  ...
  const scrollToAdjacentMomentSection = (direction, event) => {
    const section = sectionRef.current;
    const target = direction > 0 ? section?.nextElementSibling : section?.previousElementSibling;
  ...
  const handleMomentStepIntent = (direction, event) => {
    const section = sectionRef.current;
    const carousel = carouselRef.current;
  ...
  const handleManualMomentStep = (index) => {
    if (index >= activeSlideIndexRef.current) {
      return;
    }
  ...
  const handleMomentKeyDown = (event) => {
    if (event.key !== "ArrowRight" && event.key !== "ArrowLeft") {
      return;
    }
    ...
    const direction = event.key === "ArrowRight" ? 1 : -1;
    const currentIndex = activeSlideIndexRef.current;
    const nextIndex = Math.min(MOMENT_SLIDES.length - 1, Math.max(0, currentIndex + direction));
  ...
  return (
    <section className="moments" aria-labelledby="moments-title" ref={sectionRef}>
      ...
      <div
        ...
        tabIndex={0}
      >
        <div className="moments__track" style={{ transform: `translate3d(-${activeSlideIndex * 100}%, 0, 0)` }}>
          {MOMENT_SLIDES.map((slide, index) => (
            <article
              ...
              data-state={index === activeSlideIndex ? "active" : "inactive"}
              key={slide.page}
              style={{ "--moment-color": slide.color }}
            >
        ...
        <div className="moments__pagination" aria-label="For every moment pagination">
          {MOMENT_SLIDES.slice(0, activeSlideIndex + 1).map((page, pageIndex) => {
            const isPastSlide = pageIndex < activeSlideIndex;
            const isActiveSlide = pageIndex === activeSlideIndex;
            ...
            return (
              <button
                ...
                style={{ "--moment-page-color": page.color, "--moment-page-text": page.activeText }}
                type="button"
              >
                {page.page}
              </button>
...
function WhatFamiliesSay() {
  ...
  return (
    <section className="family-quotes" aria-labelledby="family-quotes-title">
      ...
      <div className="family-quotes__viewport" aria-label="Family testimonials carousel">
        <div className="family-quotes__track">
          {carouselQuotes.map((item, index) => (
            <figure className="family-quotes__card" aria-hidden={index >= FAMILY_QUOTES.length} key={`${item.author}-${index}`}>
      ...
      <div className="pricing__cards">
        {PRICING_PLANS.map((plan) => (
          <article
            ...
            key={plan.price}
            style={{ "--pricing-bg": `url(${MEDIA}${plan.bg})` }}
          >
            ...
            <ul className="pricing-card__features" aria-label={`${plan.price} plan features`}>
              {plan.features.map((feature) => (
                <li key={feature}>{feature}</li>
              ))}
            </ul>

            <button className="pricing-card__cta" onClick={goToProduct} type="button">
...
function FAQSection() {
  const [openItems, setOpenItems] = useState(() => {
    try {
      ...
      return Array.isArray(parsed) ? parsed.filter((id) => FAQ_ITEMS.some((item) => item.id === id)) : [];
    } catch {
      return [];
    }
  });
    ...
    <section className="faq" aria-labelledby="faq-title">
      ...
      <div className="faq__list">
        {FAQ_ITEMS.map((item) => {
          ...
          return (
            <article className="faq-card" data-state={isOpen ? "open" : "closed"} key={item.id}>
              <button
    ...
    <section className="final-cta" aria-labelledby="final-cta-title">
      <div className="final-cta__inner">
        ...
        <p>
          ...
          <span>No card, no pressure &mdash; just a chance to see what your child does with it.</span>
        </p>
        <button className="final-cta__button" onClick={goToProduct} type="button">
  ...
  return (
    <footer className="landing-footer">
      <div className="landing-footer__inner">
        <img className="landing-footer__logo" src={`${MEDIA}logo-dark.png`} alt="anyturn" />

        <nav className="landing-footer__nav" aria-label="Footer navigation">
          {FOOTER_LINKS.map((link) => (
            <button key={link.label} onClick={() => setActiveModal(link)} type="button">
              {link.label}
            </button>
          ))}
        </nav>

        <p className="landing-footer__copyright">&copy; 2026 Anyturn Ltd. Made with <span>♥</span> in London.</p>
      </div>

      {activeModal ? (
        <div className="footer-modal" role="dialog" aria-modal="true" aria-labelledby="footer-modal-title">
          <button className="footer-modal__backdrop" onClick={() => setActiveModal(null)} type="button" aria-label="Close popup" />
          <div className="footer-modal__panel">
            <button className="footer-modal__close" onClick={() => setActiveModal(null)} type="button" aria-label="Close popup">
              ×
            </button>
