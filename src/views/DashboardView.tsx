...
export default function DashboardView() {
  ...
  const [newAge, setNewAge] = useState<string>("5");
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle,rgba(108,99,255,0.05),transparent 65%)",
          top: -80,
          right: -60,
          pointerEvents: "none",
        }}
      ...
      >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <PillBtn
                variant="subtle"
                onClick={toggleLang}
                style={{ padding: "8px 12px", borderRadius: T.r }}
              >
                <Globe size={14} />
              ...
              <PillBtn
                ...
                style={{ padding: "8px 10px", borderRadius: T.r }}
                title="Settings"
              >
                <Settings size={14} />
              </PillBtn>
                  ...
                  style={{
                    ...
                    background:
                      activeChild?.id === ch.id
                        ...
                        : T.bgMuted,
                    color: activeChild?.id === ch.id ? "#fff" : T.tx,
                    fontWeight: 600,
                    fontSize: 14,
                  }}
                >
        ...
        {/* Character picker */}
        {activeChild && characters.length > 0 && (
          <AnimIn delay={0.08}>
            <div className="skazka-card" style={{ marginBottom: 16 }}>
              <SectionLabel>
                {lang === "ru" ? "Выберите персонажа" : "Pick a character"}
              </SectionLabel>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <div
                  ...
                  style={{
                    ...
                    transition: "all .25s",
                    background:
                      selectedChars.length === 0 ? T.accentBg : T.bgMuted,
                    border: `2px solid ${selectedChars.length === 0 ? T.accent : "transparent"}`,
                  }}
                >
                  <div
                    style={{
                  ...
                  <div>
                    <div style={{ fontWeight: 600, fontSize: 13, color: T.tx }}>
                      {lang === "ru" ? "Новый герой" : "New character"}
                    </div>
                  </div>
                </div>
                {characters.map((c) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        cursor: "pointer",
                        transition: "all .25s",
                        background: isSelected ? T.tealBg : T.bgMuted,
                        border: `2px solid ${isSelected ? T.teal : "transparent"}`,
                        position: "relative",
                      }}
                    >
                      {c.portrait_url ? (
                      ...
                      <div>
                        <div
                          style={{ fontWeight: 600, fontSize: 13, color: T.tx }}
                        >
                          {c.name}
                        </div>
                        <div style={{ fontSize: 10, color: T.tx3 }}>
                          {c.stories_count || 0}{" "}
                          {lang === "ru" ? "историй" : "stories"}
                        </div>
                      </div>
                      {isSelected && (
                        <div
              ...
              {selectedChars.length > 0 &&
                (() => {
                  ...
                  const suggested = characters.filter((c) =>
                        ...
                        {suggested.map((c) => (
                          <div
                            ...
                            onMouseOver={(e) => {
                              ...
                              e.currentTarget.style.background = T.tealBg;
                            }}
                            onMouseOut={(e) => {
        ...
        {childrenList.length > 0 && (
          <AnimIn delay={0.12}>
            <div
              ...
              style={{
                marginBottom: 16,
                cursor: activeChild ? "pointer" : "default",
                background: activeChild
                  ? `linear-gradient(135deg,${T.accent},#7B68EE,${T.accentSoft})`
                  : T.bgCard,
                border: "none",
                padding: "26px 24px",
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                ...
                <div>
                  ...
                  <p
                    style={{
                      fontSize: 12,
                      color: activeChild ? "rgba(255,255,255,0.7)" : T.tx3,
                    }}
                  >
                    {activeChild
                      ? lang === "ru"
                        ? `Создать историю для ${activeChild.name}`
                        : `Create story for ${activeChild.name}`
                      : L.forWhom}
                  </p>
                </div>
              </div>
        ...
        {/* History fallback */}
        {library.length === 0 && sessions.length > 0 && (
          <AnimIn delay={0.18}>
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: 11, color: T.tx3 }}>
                        {s.child?.name} · {Math.ceil((s.duration || 0) / 60)}{" "}
                        {L.min} · {s.pages?.length || 0} {L.pages}
                      </div>
                    </div>
        ...
        <AnimIn delay={0.22}>
          <div style={{ textAlign: "center", marginTop: 24 }}>
            <PillBtn
              variant="subtle"
              onClick={logout}
              style={{ fontSize: 12, gap: 6, color: T.tx3 }}
            >
              <LogOut size={12} />
              {L.logout}
            </PillBtn>
