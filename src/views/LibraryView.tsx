import { AnimIn, CSS, PillBtn, T } from "components/UI";
import { useApp } from "context/AppContext";
import { getBookWithPages } from "lib/db";
...
export default function LibraryView() {
  ...
  if (readingBook) {
    return (
      <ReadingView book={readingBook} onBack={() => setReadingBook(null)} />
    );
  }
          ...
          <AnimIn delay={0.1}>
            <div style={{ textAlign: "center", padding: "60px 20px" }}>
              ...
              <p style={{ fontSize: 12, color: T.tx3 }}>
                {lang === "ru"
                  ? "Завершённые истории появятся здесь"
                      ...
                      {book.ending_type && (
                        <div
                          style={{
                            ...
                            padding: "3px 8px",
                            borderRadius: 8,
                            background: endBgs[book.ending_type],
                            fontSize: 10,
                            fontWeight: 700,
                            color: endColors[book.ending_type],
                          }}
                        >
